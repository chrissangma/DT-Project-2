...
<span class="brk"></span>
<p>Collaboration helps students understand writing as a public, communal act, rather than as a private, isolated one. Many students write papers that make sense to them but that aren't clear or persuasive for others. Peer reviewers help students to understand that they aren't writing for themselves, but for readers. Collaboration therefore helps student writers to develop a sense of audience. Too often students write only to please their instructors, whose expectations they rarely understand. Knowing that their peers will read their papers gives students a concrete sense of to whom they are writing, and why.</p>
...
<h2>Who We Are?</h2>
<span class="brk"></span>
<p style="text-align:justified">For the past three decades, educators have recognized the value of learning collaboratively. Educators widely recognize that students do not learn well when they are isolated "receivers" of knowledge. 
Indeed, students must overcome isolation in order to learn to write. Collaborative learning exercises—such as peer review workshops, collaborative research assignments, group presentations, collaborative papers and discussion groups—are important components of our writing classrooms because they encourage active learning, giving students the opportunity to become more deeply engaged with their writing, and with one another.</p>
